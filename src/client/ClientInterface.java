...
public class ClientInterface {
    ...
    Response openAccount(Account account)
    {
        ...
        byte[] content = MessageHandler.marshalRequest(request);
    ...
    {
        Request request = new Request(request_id, OpType.TRANSFER_MONEY.getCode(),new Object[]{accountFrom, accountTo, amount});
        byte[] content = MessageHandler.marshalRequest(request);
        sendRequest(server_ip, server_port, content);
        Response response = receiveResponse();
        return response;
    ...
    Response receiveResponse()
    {
        ...
        Response response = MessageHandler.unmarshalResponse(msg);
        return response;
    }
