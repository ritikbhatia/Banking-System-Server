...
public class DepositMoney extends Service{
    ...
    public Response depositMoney(String accountHolderName, String password, int currencyCode, double amount, int accountNumber){
        ...
        if(bankAccount.getCurrency() != currency){
            ...
            Transaction transaction = new Transaction(OpType.DEPOSIT_MONEY, currency, amount, bankAccount.getBalance(), "Total Balance: " + bankAccount.getBalance());
